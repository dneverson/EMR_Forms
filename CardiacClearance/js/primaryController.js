...
(function(){
  var formApp = angular.module('cardiacClearanceApp', []);
  formApp.controller('cardiacClearanceController', function ($scope, $parse, $window, $interval, $http) {
