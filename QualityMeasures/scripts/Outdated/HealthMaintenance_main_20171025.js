...
function fnHMGetScreenings() {
	...
	screeningHTML = screeningHTML + '<tr><th>Screening</th><th class="text-center">Result (Date)</th><th class="text-center" width="300">Add New Screening Record</th></tr>';
...
function fnCreateTR(obsData) {
	...
	returnTR = returnTR +   "<div class='tblInputDiv'><button class='btn btn-primary btn-sm' onclick='fnAddObs(this,\"" + obsData[1] + "\",\"" + obsData[0] + "\")'>Add</button></div>";
